...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-spparow.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='data/arow.data', help='coco.data file path')
    parser.add_argument('--weights', type=str, default='weights/best.pt', help='path to weights file')
    parser.add_argument('--images', type=str, default='C:\\Users\\kay\\PycharmProjects\\untitled1\\images\\output', help='path to images')
